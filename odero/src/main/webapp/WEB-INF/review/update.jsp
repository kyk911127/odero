		...
		<table class="table table-hover" style="width: 70%; margin: 0px auto;" >
			<tr>
				...
				<td width="80%" class="text-left">
					<input type="text" name="r_subject" id="r_subject" size="50" value="${vo.r_subject }">
			...
			<tr>
				...
				<td width="80%" class="text-left">
					<input type="text" name="r_pname" id="r_pname" size="50" value="${vo.r_pname }">
				</td>
			</tr>
			<tr>
				<td width="20%" class="text-center warning">작성자</td>
				<td width="80%" class="text-left">
					<input type="text" name="m_id" size="20" readonly="readonly" value="${vo.m_id }">
				</td>
			</tr>
			<tr>
				<td width="20%" class="text-center warning">주소</td>
				<td width="80%" class="text-left">
					<input type="text" name="r_addr" id="r_addr" size="50" readonly value="${vo.r_addr }">
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				<td colspan="2">
					<textarea rows="10" cols="100%" name="r_content" id="r_content" >${vo.r_content}</textarea>
				</td>
			</tr>
			<tr>
